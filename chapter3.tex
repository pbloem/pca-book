...
\begin{figure}[H]
	\centerline{
	\hspace{-0.9cm}\includegraphics[width=1.1\textwidth]{./images/pca-3/train.pdf}
	}
\end{figure}
%<figure class="narrow">
...
\begin{figure}[H]
	\centerline{
	\hspace{1em}\includegraphics[width=1.2\textwidth]{./images/pca-3/sum.pdf}
	}
...
\begin{figure}[H]
	\centerline{
	\hspace{0.5em}\includegraphics[width=1\textwidth]{./images/pca-3/alternativity.pdf}
	}
...
\begin{figure}[p]
	\centerline{
		\hspace{3.5em}\includegraphics[width=0.8\textwidth]{./images/pca-3/mirrors.png}
	}
...
\noindent We'll show that the proportion of the sum contributed by the higher order terms vanishes as we get near zero, so we can take the simpler function \(q'(z) = \bc{d_0} + \bc{d_k}z^k\) as a good approximation, that becomes perfect at the origin.
